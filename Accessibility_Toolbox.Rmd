...
$$
A_i = \sum_{j}{W_jf(t_{ij})}
$$
where the accessibility $A$ of origin $i$ is the sum of all opportunities $W$ available at destinations $j$ weighted by some function of the travel time $t_{ij}$ between origins $i$ and destinations $j$.
