...
# ABSTRACT
Analyses of spatial interaction undertaken in the popular ArcGIS environment require many time-consuming and tedious steps. Moreover, questions persist over the selection of an impedance function and cost or cut-off parameters. In response, this paper details a new Accessibility Toolbox for R and ArcGIS that includes a Python tool that simplifies accessibility analysis and an interactive R Notebook that enables the visualization and customization of impedance functions and parameters. Using this toolbox, researchers and practitioners can simplify their accessibility analyses and make better decisions about the specification and customization of travel impedance for their study context.

# KEYWORDS
accessibility, walking, travel behavior, travel impedance, distance decay function

# RESEARCH QUESTIONS AND HYPOTHESES
Accessibility can be defined as the potential for reaching spatially distributed opportunities while considering the difficulty involved in traveling to them (Páez, Scott & Morency, 2012). Several families of accessibility measures have been established since the pioneering work of Hansen (1959), including infrastructure-based, person-based, place-based, and utility-based (Geurs & van Wee, 2004). Of these, place-based measures are arguably the most common and can be operationalized as:
